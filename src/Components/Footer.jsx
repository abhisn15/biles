...
const Footer = () => {
    return (
        <footer className="bg-[#35BBB9] mt-14">
            <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                <div className="md:flex md:justify-between">
                    <div className="mb-6 md:mb-0">
                        <div className="flex flex-shrink-0 items-center">
                            <Link to='/'>
                                <h1
                                    className="logo relative text-2xl w-auto font-bold"
                                ><span className='bg-gradient-to-r from-white to-[#35BBB9] text-transparent bg-clip-text'>BI</span>LES</h1>
                            </Link>
                        </div>
                    </div>
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    <span className="text-sm text-gray-500 sm:texwhite">© 2023 <a href="https://flowbite.com/" className="hover:underline">BiCorporation</a>. All Rights Reserved.
                    </span>
